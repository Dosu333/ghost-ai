...
Fetch owned and shared projects server-side using the existing data helper and pass both lists to the sidebar.
...
Create a hook in `hooks/` that manages dialog and project mutations.
...
Connect the hook to the sidebar and the dialogs.
