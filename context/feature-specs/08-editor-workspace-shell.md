Build the editor `/editor/[roomId]` workspace shell with server-side access checks. No canvas logic yet.
...
- checkin project access by owner or collaborator
...
- navbar action: share butto and AI sidebar toggle
