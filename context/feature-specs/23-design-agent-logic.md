...
## Dependencies
   All packages are already installed. The design agent accepts `GOOGLE_GENERATIVE_AI_API_KEY` as the primary env var and also supports `GEMINI_API_KEY` as a compatibility alias in the Trigger task environment.
