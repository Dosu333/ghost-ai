Add a bottom shape panel so users can drag shapes onto the canvas and create new modes.


## Implementation

1. Add a floating pill-shaped toolbar at the bottom of the center of the canvas.
...
- New nodes use the custom canvas type
